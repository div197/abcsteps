...
export const auth = betterAuth({
  ...
  trustedOrigins: ['https://localhost:3000', 'https://abcsteps.com', 'https://www.abcsteps.com'],
  allowedOrigins: ['https://localhost:3000', 'https://abcsteps.com', 'https://www.abcsteps.com'],
});
